...
export default function NavLinkItem({ text, icon, link, borderBottom }: INavLinkItemProps) {
  ...
  return (
    <NavLink
      to={`/` + link}
      className={`group relative flex items-center gap-2.5 ${borderBottom ? "border-b" : "px-9"} rounded-none py-4 px-6 font-normal duration-300 ease-in-out hover:bg-gray-100 ${
